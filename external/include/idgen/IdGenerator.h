...
public:
	...
	int64_t CalcId()
	{
		uint64_t result = (_SnowFlakeWorker._LastTimeTick << _SnowFlakeWorker._TimestampShift) | (_SnowFlakeWorker.WorkerId << _SnowFlakeWorker.SeqBitLength) | (_SnowFlakeWorker._CurrentSeqNumber);
	...
	{
		uint64_t result = (_SnowFlakeWorker._LastTimeTick << _SnowFlakeWorker._TimestampShift) | (_SnowFlakeWorker.WorkerId << _SnowFlakeWorker.SeqBitLength) | (_SnowFlakeWorker._TurnBackIndex);
	...
	int64_t WorkerM2NextId()
	{
		...
		_SnowFlakeWorker._LastTimeTick = currentTimeTick;
		int64_t id = (int64_t)((currentTimeTick << _SnowFlakeWorker._TimestampShift) | (_SnowFlakeWorker.WorkerId << _SnowFlakeWorker.SeqBitLength) | _SnowFlakeWorker._CurrentSeqNumber);
...
private:
	inline static IdGenerator* instance = nullptr;
};
